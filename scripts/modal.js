...
const projectList = [
  ...
  },
  {
    ...
    projectbtnlive: 'https://abiodunraheem.github.io/Abiodun-Portfolio/',
    projectbtnsource: 'https://abiodunraheem.github.io/Abiodun-Portfolio/',
  },
];
  ...
  <div class="popupcont">
      ...
      <div class="popupcontbody">
        ...
        <div class="popupcontbodyright">
          ...
          <a href="https://abiodunraheem.github.io/Abiodun-Portfolio/"><button type="button" id="modalbtns live">See Live <img src="./images/viewlive.png" alt="view live"></button></a>
          <a href="https://github.com/abiodunraheem/Abiodun-Portfolio"><button type="button" id="modalbtns live">See Source <img src="./images/viewsource.png" alt="view Source"></button></a>
          </div>
        </div>
      </div>
    </div>
